  ...
  class HtmlSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      if (trial.show_slider_start === false) {
            html += '<input type="range" class="jspsych-slider-unclicked" value="' + trial.slider_start + '" min="' + trial.min + '" max="' + trial.max + '" step="' + trial.step + '" id="jspsych-html-slider-response-response"></input>'
          } else {
